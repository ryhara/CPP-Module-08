...
int main(void)
{
	...
	}
	{
		...
		try {
			std::cout << "span.addNumber(v.begin(), v.end()): " << std::endl;
			span.addNumber(v.begin(), v.end());
			std::cout << "min element: " << *(std::min_element(span.begin(), span.end())) << std::endl;
			std::cout << "max element: " << *(std::max_element(span.begin(), span.end())) << std::endl;
			std::cout << "span.shortestSpan(): " << span.shortestSpan() << std::endl;
			std::cout << "span.longestSpan(): " << span.longestSpan() << std::endl;
			std::cout << "span.addNumber(1);" << std::endl;
			span.addNumber(1);
	...
	{
		std::cout << "----- empty or one element span test -----" << std::endl;
		Span span(100);
		try {
		...
		try {
			span.addNumber(1);
			std::cout << "span is one element" << std::endl;
			std::cout << "span.shortestSpan(): " << span.shortestSpan() << std::endl;
		}
		catch (std::exception &e)
		{
